...
class QueryBuilder
{
    ...
    {
        return $this->addRootTable($table, AbstractTable::ROOT_INSERT);
    }
    ...
    {
        $this->queryClauses->setInsertColumns($columns);
     ...
     * @return $this
     */
    public function addInsertValues(array $values = [])
    {
        $valueReferences = [];

        foreach ($values as $value) {
            $valueReferences = $this->referenceManager->register($value);
        }

        $this->queryClauses->addInsertValue($valueReferences);
